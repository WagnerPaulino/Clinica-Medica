 ...
 * @author ASUSX451
 */
public class TelaAlterarPaciente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setBounds(340, 0, 542, 620);
    }// </editor-fold>//GEN-END:initComponents

    private void jbPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPesquisarActionPerformed
        try {
            PacienteDAO pacienteDAO = new PacienteDAO();
            paciente = pacienteDAO.buscarUmPaciente(jftfCpfPesquisa.getText());
            jtfNome.setText(paciente.getNome());
            jtfRg.setText(Integer.toString(paciente.getRg()));
            jftfCpf.setText(paciente.getCpf());
            jftfDataNas.setText(paciente.getDtNascimento());
            jcbSexo.setSelectedItem(paciente.getSexo());
            jtfRua.setText(paciente.getRua());
            jtfNumCasa.setText(paciente.getNumCasa());
            jtfCidade.setText(paciente.getCidade());
            jtfBairro.setText(paciente.getBairro());
            jftfCep.setText(paciente.getCep());
            jftfResidencial.setText(paciente.getResidencial());
            jftfCelular.setText(paciente.getCelular());
            jtfEmail.setText(paciente.getEmail());
    ...
    private void jbCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCadastrarActionPerformed
        ...
        try {           
            ...
            paciente.setRg(Integer.parseInt(jtfRg.getText()));
            paciente.setCpf(jftfCpf.getText());
            paciente.setDtNascimento(jftfDataNas.getText());
            paciente.setSexo(jcbSexo.getSelectedItem().toString());
            paciente.setRua(jtfRua.getText());
            paciente.setNumCasa(jtfNumCasa.getText());
            paciente.setCidade(jtfCidade.getText());
            paciente.setBairro(jtfBairro.getText());
            paciente.setCep(jftfCep.getText());
            paciente.setResidencial(jftfResidencial.getText());
            paciente.setCelular(jftfCelular.getText());
            paciente.setEmail(jtfEmail.getText());
            
            PacienteDAO pacienteDAO = new PacienteDAO();
            pacienteDAO.save(paciente);
            
            JOptionPane.showMessageDialog(this, "Dados do paciente salvados com sucesso!");
            jtfNome.setText("");
            jftfCpfPesquisa.setText("");
            jtfRg.setText("");
            jftfCpf.setText("");
           ...
           jtfEmail.setText("");
            ...
            JOptionPane.showMessageDialog(this, " Erro ao alterar dados do paciente:\n " + e);
        }finally{
